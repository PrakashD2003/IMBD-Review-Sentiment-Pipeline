"""Utility script to promote a staging model to production in MLflow."""
...
from common.utils.mlflow_utils import configure_mlflow, get_latest_version
from common.constants import MLFLOW_TRACKING_URI, MODEL_NAME
